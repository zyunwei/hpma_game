require 'client'
custom_item_consumable_0703 = CustomItemSpellSystem:GetBaseClass()

local public = custom_item_consumable_0703
...
function public:OnCustomSpellStart(item)
    ...
    caster:ModifyCustomAttribute("mana", "item_consumable_0703", mana)
    caster:ModifyCustomAttribute("mana_regen_pct", "item_consumable_0703", mana_regen)
    caster:AddConsumableUseCount("item_consumable_0703")
