...
GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_GOODGUYS,  0)  -- 天辉
...
GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_CUSTOM_1,  1)  -- 自定义队伍1
GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_CUSTOM_2,  1)  -- 自定义队伍2
